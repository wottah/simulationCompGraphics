...
namespace Project1
{
	class MaxRodConstraint: IDrawableConstraint
	{
		private readonly int _p1;
		private readonly int _p2;
		private readonly float _dist;

		public MaxRodConstraint(int p1, int p2, float dist)
		{
			_p1 = p1;
			_p2 = p2;
			_dist = dist;
		...
		private bool Active(Particle p1, Particle p2)
		{
			//return (p1.Position - p2.Position).GetLengthSquared() >= _dist*_dist &&
			return p1.ForceAccumulator.Normilize().DotProduct(p2.ForceAccumulator.Normilize()) < 1;
		}
